...
class CheckingQueryHandlerTest {
    ...
    void handle_GetPersonsCheckingsQuery() {
        ...
        Map<String, List<Checking>> result = checkingQueryHandler.handle(query);
    ...
    void handle_GetUserCheckingsByDatesAndPersonsMapQuery() {
        ...
        Map<LocalDate, Map<String, List<Checking>>> result = checkingQueryHandler.handle(query);
    ...
    void handle_GetUserCheckingsByPersonsAndDatesMapQuery() {
        ...
        Map<String, Map<LocalDate, List<Checking>>> result = checkingQueryHandler.handle(query);
